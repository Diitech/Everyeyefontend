import{j as e,a6 as r,U as c,aE as d,i as m,m as g,T as x,g as u,aF as p,aG as h}from"./ui-vendor-iTKbCRXJ.js";import{b as n,B as b}from"./index-Dwvyp7rG.js";import{S as y}from"./SEO-CgAC7V99.js";import{l as f,i as w,r as v,L as o}from"./react-vendor-C8DdfftJ.js";import"./radix-DwYa3b9T.js";import"./charts-D_VVxdgE.js";const j={"build-7-figure-digital-product-business":{content:`
    ...
    `,tags:["Business","Entrepreneurship","Digital Products","Marketing","Growth"]},"complete-guide-design-systems-2026":{content:`
    ...
    `,tags:["Design","UI/UX","Design Systems","Product Design","Frontend"]},"ai-tools-transform-creative-workflow":{content:`
    ...
    `,tags:["AI","Technology","Creativity","Productivity","Tools"]}};function S(){const{slug:i}=f(),l=w(),t=n.find(s=>s.slug===i),a=i?j[i]:null;return v.useEffect(()=>{t||l("/blog"),window.scrollTo(0,0)},[t,l]),t?e.jsxs(e.Fragment,{children:[e.jsx(y,{title:t.title,description:t.excerpt}),e.jsxs("main",{className:"pt-[72px] min-h-screen bg-dark",children:[e.jsx("section",{className:"py-12 border-b border-border",children:e.jsxs("div",{className:"max-w-[900px] mx-auto px-4 sm:px-6 lg:px-16",children:[e.jsxs(o,{to:"/blog",className:"inline-flex items-center text-sm text-gray-400 hover:text-white transition-colors mb-6",children:[e.jsx(r,{className:"w-4 h-4 mr-2"}),"Back to Blog"]}),e.jsx(b,{className:"mb-4 bg-coral/20 text-coral border-coral/30",children:t.category}),e.jsx("h1",{className:"text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6",children:t.title}),e.jsxs("div",{className:"flex flex-wrap items-center gap-4 text-sm text-gray-400",children:[e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(c,{className:"w-4 h-4"}),t.author]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(d,{className:"w-4 h-4"}),t.date]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(m,{className:"w-4 h-4"}),t.readTime]})]})]})}),e.jsx("section",{className:"py-8",children:e.jsx("div",{className:"max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-16",children:e.jsx("div",{className:"aspect-video rounded-2xl overflow-hidden",children:e.jsx("img",{src:t.image,alt:t.title,className:"w-full h-full object-cover"})})})}),e.jsx("section",{className:"py-8",children:e.jsxs("div",{className:"max-w-[800px] mx-auto px-4 sm:px-6 lg:px-16",children:[e.jsx(g.article,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},className:"prose prose-invert prose-lg max-w-none",dangerouslySetInnerHTML:{__html:a?.content||`<p class="text-gray-400">${t.excerpt}</p>`}}),a?.tags&&e.jsx("div",{className:"mt-10 pt-6 border-t border-border",children:e.jsx("div",{className:"flex flex-wrap gap-2",children:a.tags.map(s=>e.jsx("span",{className:"px-3 py-1 bg-dark-100 text-gray-400 text-sm rounded-full border border-border",children:s},s))})}),e.jsxs("div",{className:"mt-8 pt-6 border-t border-border",children:[e.jsx("p",{className:"text-gray-400 text-sm mb-3",children:"Share this article"}),e.jsxs("div",{className:"flex gap-3",children:[e.jsx("button",{className:"w-10 h-10 rounded-lg bg-dark-100 flex items-center justify-center text-gray-400 hover:text-white hover:bg-coral/20 transition-colors",children:e.jsx(x,{className:"w-5 h-5"})}),e.jsx("button",{className:"w-10 h-10 rounded-lg bg-dark-100 flex items-center justify-center text-gray-400 hover:text-white hover:bg-coral/20 transition-colors",children:e.jsx(u,{className:"w-5 h-5"})}),e.jsx("button",{className:"w-10 h-10 rounded-lg bg-dark-100 flex items-center justify-center text-gray-400 hover:text-white hover:bg-coral/20 transition-colors",children:e.jsx(p,{className:"w-5 h-5"})}),e.jsx("button",{className:"w-10 h-10 rounded-lg bg-dark-100 flex items-center justify-center text-gray-400 hover:text-white hover:bg-coral/20 transition-colors",children:e.jsx(h,{className:"w-5 h-5"})})]})]})]})}),e.jsx("section",{className:"py-16 bg-dark-100",children:e.jsxs("div",{className:"max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-16",children:[e.jsx("h2",{className:"text-2xl font-bold text-white mb-8",children:"More Articles"}),e.jsx("div",{className:"grid sm:grid-cols-2 lg:grid-cols-3 gap-6",children:n.filter(s=>s.id!==t.id).slice(0,3).map(s=>e.jsx(o,{to:`/blog/${s.slug}`,className:"block group",children:e.jsxs("div",{className:"bg-dark rounded-xl overflow-hidden border border-border hover:border-coral/50 transition-colors",children:[e.jsx("div",{className:"aspect-video overflow-hidden",children:e.jsx("img",{src:s.image,alt:s.title,className:"w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"})}),e.jsx("div",{className:"p-4",children:e.jsx("h3",{className:"text-white font-semibold group-hover:text-coral transition-colors line-clamp-2",children:s.title})})]})},s.id))})]})})]})]}):null}export{S as BlogDetail};
